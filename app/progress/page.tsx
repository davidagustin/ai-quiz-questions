      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 text-center">
              <div className="text-3xl font-bold text-white mb-2">{completedQuizzes}/{totalQuizzes}</div>
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          {Object.entries(quizData).map(([key, category]) => {
            ...
            return (
              <div key={key} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">{category.questions.length} questions</p>
                    </div>
                  </div>
                  ...
                  <div className="text-right">
                    {isCompleted ? (
                      ...
                      <div className="text-gray-400">Not attempted</div>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {Object.entries(progress)
                      ...
                      .map(([key, p]) => (
                        <div key={key} className="flex items-center justify-between bg-green-500/10 rounded-lg p-3 border border-green-500/20">
                          <span className="text-green-300">{quizData[key].title}</span>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {Object.entries(progress)
                      ...
                      .map(([key, p]) => (
                        <div key={key} className="flex items-center justify-between bg-red-500/10 rounded-lg p-3 border border-red-500/20">
                          <span className="text-red-300">{quizData[key].title}</span>
                    ...
                    {Object.entries(progress).filter(([_, p]) => p.completed && p.score && (p.score / p.totalQuestions) < 0.6).length === 0 && (
                      <p className="text-gray-400">Great job! All completed quizzes are above 60%.</p>
                    )}
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Review Mnemonics</h3>
                    <p className="text-gray-300">Visit the mnemonics page to reinforce key concepts.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <span className="text-2xl mr-3">🔄</span>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Retake Low-Score Quizzes</h3>
                    <p className="text-gray-300">Focus on categories where you scored below 60%.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Take quizzes weekly to maintain knowledge retention.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <span className="text-2xl mr-3">📖</span>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Read Explanations</h3>
                    <p className="text-gray-300">Always review explanations for incorrect answers.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="text-center mt-16 text-gray-400">
          <div className="flex justify-center space-x-6">
            ...
            <Link href="/mnemonics" className="text-purple-400 hover:text-purple-300 transition-colors">
              📚 View Mnemonics
            </Link>
          </div>
        </div>
